...
1. concurrent activity emotions (e.g. enjoyment or boredom during learning);
2. prospective outcome emotions (e.g. hope and anxiety);
3. retrospective outcome emotions (e.g. pride and shame)
...
## Further Reading
- [Control-Value Theory: From Achievement Emotion to a General Theory of Human Emotion](https://link.springer.com/article/10.1007/s10648-024-09909-7?fromPaywallRec=true) (Pekrun, 2024)