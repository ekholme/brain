...
tags:
  - programming/python
---
[uv](https://docs.astral.sh/uv/) is a python package and project manager, written in Rust. It's really fast and feels really good.
...
`uv add --editable path/to/my-local-package`
